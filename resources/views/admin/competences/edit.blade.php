...
<head>
    ...
    <title>Modifier une compétence | Administration</title>
...
<main class="main">
    ...
    <div class="form-card">
        ...
        <form
            action="{{ route('admin.competences.update', $competence) }}"
            method="POST">
                ...
                <div class="form-group">
                    ...
                    <select
                        ...
                        <option value="Débutant"
                            {{ old('niveau', $competence->niveau) == 'Débutant' ? 'selected' : '' }}>
                            Débutant
                        </option>


                        <option value="Intermédiaire"
                            {{ old('niveau', $competence->niveau) == 'Intermédiaire' ? 'selected' : '' }}>
                            Intermédiaire
                        </option>


                        <option value="Avancé"
                            {{ old('niveau', $competence->niveau) == 'Avancé' ? 'selected' : '' }}>
                            Avancé
                        </option>


                        <option value="Expert"
                            {{ old('niveau', $competence->niveau) == 'Expert' ? 'selected' : '' }}>
                            Expert
                        </option>
