...
@section('title', 'Ajouter une formation | Administration')
...
<div class="form-page">
    ...
    <div class="form-header">
        ...
        <p>
            Ajoutez une nouvelle formation à votre parcours académique.
        </p>
    ...
    <div class="form-card">
        ...
        <form
            action="{{ route('admin.formations.store') }}"
            method="POST">
            ...
            <div class="form-group">
                ...
                <textarea
                    ...
                    placeholder="Décrivez brièvement cette formation, les compétences acquises ou la spécialité...">{{ old('description') }}</textarea>
